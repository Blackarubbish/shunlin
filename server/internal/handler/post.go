...
func GetPosts(c *gin.Context) {
	...
	data, err := service.GetPosts(query)
...
func CreatePost(c *gin.Context) {
	...
	post, err := service.CreatePost(c, postRequest)
	if err != nil {
...
func GetOnePost(c *gin.Context) {
	...
	post, err := service.GetOnePostByID(uint(idUint))
	if err != nil {
...
func UpdatePost(c *gin.Context) {
	...
	post, err := service.UpdatePost(uint(idUint), updatePostRequest)
	if err != nil {
...
func DeletePost(c *gin.Context) {
	...
	err = service.DeletePost(uint(idUint))
	if err != nil {
